...
namespace Dapper.SimpleRepository
{
    ...
    /// </summary>
    internal static partial class SimpleCRUD
    {
        ...
        /// </summary>
        /// <returns></returns>
        internal static string GetDialect()
        {
        ...
        internal static void SetDialect(Dialect dialect)
        {
            switch (dialect)
            {
        ...
        internal static void SetTableNameResolver(ITableNameResolver resolver)
        {
        ...
        internal static void SetColumnNameResolver(IColumnNameResolver resolver)
        {
        ...
        internal static T Get<T>(this IDbConnection connection, object id, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        internal static IEnumerable<T> GetList<T>(this IDbConnection connection, object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
        ...
        internal static IEnumerable<T> GetList<T>(this IDbConnection connection, string conditions, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
        ...
        internal static IEnumerable<T> GetList<T>(this IDbConnection connection)
        {
        ...
        internal static IEnumerable<T> GetListPaged<T>(this IDbConnection connection, int pageNumber, int rowsPerPage, string conditions, string orderby, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        internal static int? Insert<TEntity>(this IDbConnection connection, TEntity entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        internal static TKey Insert<TKey, TEntity>(this IDbConnection connection, TEntity entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        internal static int Update<TEntity>(this IDbConnection connection, TEntity entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        internal static int Delete<T>(this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var masterSb = new StringBuilder();
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records affected</returns>
        internal static int Delete<T>(this IDbConnection connection, object id, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records affected</returns>
        internal static int DeleteList<T>(this IDbConnection connection, object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var masterSb = new StringBuilder();
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records affected</returns>
        internal static int DeleteList<T>(this IDbConnection connection, string conditions, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var masterSb = new StringBuilder();
        ...
        internal static int RecordCount<T>(this IDbConnection connection, string conditions = "", object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            var sb = new StringBuilder();
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>Returns a count of records.</returns>
        internal static int RecordCount<T>(this IDbConnection connection, object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
        ...
        internal interface ITableNameResolver
        {
            string ResolveTableName(Type type);
        }

        internal interface IColumnNameResolver
        {
    ...
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    internal class IgnoreSelectAttribute : Attribute
    {
    }
    ...
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    internal class IgnoreUpdateAttribute : Attribute
    {
    }
